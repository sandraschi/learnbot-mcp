...
a = Analysis(
    ['run_server.py'],
    pathex=['src'],
    datas=[('src/learnbot_mcp', 'learnbot_mcp'), ('webapp/dist', 'webapp/dist')],
    hiddenimports=[
        ...
        'aiosqlite', 'httpx', 'pydantic', 'pydantic_settings',
    ],
    excludes=['tkinter', 'setuptools', 'pip', 'wheel', 'test', 'tests', 'unittest', '_distutils_hack'],
    noarchive=True,
)
_keep_dist = ['fastmcp-', 'mcp-', 'pydantic-', 'pydantic_settings-', 'email_validator-']
...
exe = EXE(pyz, a.scripts, a.binaries, a.zipfiles, a.datas,
          name='learnbot-mcp-backend', debug=False, strip=False, upx=False,
