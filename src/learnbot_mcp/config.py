...
class Settings(BaseSettings):
    ...
    regulatory_regime: str = Field(default="none", alias="LEARNBOT_REGULATORY_REGIME")
    real_name_auth: bool = Field(default=False, alias="LEARNBOT_REAL_NAME_AUTH")
    conversation_retention_days: int = Field(default=90, alias="LEARNBOT_RETENTION_DAYS")
    ...
    api_key: str = Field(default="", alias="LEARNBOT_API_KEY")
